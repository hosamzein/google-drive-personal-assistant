...
- **Data Preservation**: Safeguard personal recipes, tax documents, and letters by automatically backing up your files to a local drive before doing any format conversions.
...
1. Double-click the **`run_app.bat`** file in the project folder to instantly launch the user interface.
2. Select your virtual Google Drive directory as the **Source Folder**.
3. Choose whether to back up your folder first, dry-run validate, or safely delete the shortcuts.
4. Click **Start Backup & Conversion Process** and monitor the live log console!
